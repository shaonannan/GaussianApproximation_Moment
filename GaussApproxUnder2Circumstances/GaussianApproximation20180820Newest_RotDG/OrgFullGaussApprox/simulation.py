...
#                for i in range(0,NPATCH*self.NPHA):
...
#                    plt.pause(0.1)
            ...
            if np.mod(counter,5000)==0:
                icounter = np.ceil(counter/5000)
                ip = int((icounter-1)*500)
                ic = int((icounter)*500)
                ...
                scio.savemat(filename,{'mEbin_ra':self.mEbin_ra[ip:ic],'mIbin_ra':self.mIbin_ra[ip:ic],'xEbin_ra':self.xEbin_ra[ip:ic],'xIbin_ra':self.xIbin_ra[ip:ic],\
                                       'VEavgbin_ra':self.VEavgbin_ra[ip:ic],'VIavgbin_ra':self.VIavgbin_ra[ip:ic],'VEstdbin_ra':self.VEstdbin_ra[ip:ic],\
                                       'VIstdbin_ra':self.VIstdbin_ra[ip:ic],'nEbin_ra':self.nEbin_ra[ip:ic],'nIbin_ra':self.nIbin_ra[ip:ic]}) 
